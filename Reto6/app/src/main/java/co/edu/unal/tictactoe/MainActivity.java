...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Restore the scores
        humanCount = mPrefs.getInt("mHumanCount", 0);
        androidCount = mPrefs.getInt("mAndroidCount", 0);
        tieCount = mPrefs.getInt("mTieCount", 0);
        displayScores();
    }
    private void displayScores() {
        mHumanCount.setText("Human: " + Integer.toString(humanCount));
        mTieCount.setText("Tie: " + Integer.toString(tieCount));
        mAndroidCount.setText("Human: " + Integer.toString(androidCount));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("mHumanWins", humanCount);
        outState.putInt("mComputerWins", androidCount);
        outState.putInt("mTies", tieCount);
    ...
    protected void onStop() {
        ...
        ed.putInt("mHumanCount", humanCount);
        ed.putInt("mAndroidCount", androidCount);
        ed.putInt("mTieCount", tieCount);
        ed.apply();
    }
